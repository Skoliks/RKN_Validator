...
| Cookie banner and optional cookie consent | No | `BrowserClient` only provides optional browser evidence collection | `CookieAnalyzer` for banner text, accept/decline controls, and pre-consent optional scripts | Medium |
